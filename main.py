...
if __name__ == '__main__':
    ...
    parser.add_argument('--model', default='dc-cnn',
                        choices=['dc-cnn', 'lpd-net', 'hqs-net', 'hqs-net-unet', 'ista-net-plus', 'lowrank'],
                        help='models to reconstruct')
    parser.add_argument('--acc', type=int, default=10,
                        help='Acceleration factor for k-space sampling')
    ############################### dataset setting ###############################

    parser.add_argument('--train_path', default="data1/fs_train.npy",
                        help='train_path')
    parser.add_argument('--val_path', default="data1/fs_val.npy",
                        help='val_path')
